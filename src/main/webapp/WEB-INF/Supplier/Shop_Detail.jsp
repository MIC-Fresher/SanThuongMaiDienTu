                ...
                <section class="content-header">
                    ...
                    <section class="content">
                        ...
                        <c:if test="${not empty shopDetail}">
                            ...
                            <jsp:include page="/WEB-INF/Include/Supplier/shops/table/TableDetailShop.jsp"></jsp:include>
                            <jsp:include page="/WEB-INF/Include/Supplier/shops/table/TableCategoriesOfShop.jsp"></jsp:include>
                            <jsp:include page="/WEB-INF/Include/Supplier/shops/form/setroleshop.jsp"></jsp:include>
