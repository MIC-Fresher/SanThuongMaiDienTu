        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <jsp:include page="/WEB-INF/Include/Supplier/order/order_search/search_form.jsp"></jsp:include>
                    </section>
                    ...
                    <section class="content">
                        ...
                        <c:if test="${not empty order}">
                            ...
                            <form:form action="${orderform}" id="order_form" method="POST" commandName="order" >
                                ...
                                <jsp:include page="/WEB-INF/Include/Supplier/order/order_detail/user_infomation.jsp"></jsp:include>
                                <jsp:include page="/WEB-INF/Include/Supplier/order/order_detail/receiver_infomation.jsp"></jsp:include>
                                <jsp:include page="/WEB-INF/Include/Supplier/order/order_detail/order_infomation.jsp"></jsp:include>
                                <jsp:include page="/WEB-INF/Include/Supplier/order/order_detail/order_details_infomation.jsp"></jsp:include>
                            </form:form>
                        </c:if>
                    </div>
