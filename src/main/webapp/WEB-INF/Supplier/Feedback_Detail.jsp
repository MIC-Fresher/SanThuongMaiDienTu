            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <s:url value="/Supplier/deleteFeedBack?id=${feedBackForm.feedbackId}&page=${requestScope.listFeedbacks.current}" var="delete"/>
                                    <h3 class="box-title">
                                        <a class="btn btn-primary btn-lg" href="javascript:{}" onclick="deleteFeedback('${delete}')">
                                            Xóa phản hồi này
                                        </a> 
                        ...
                        <jsp:include page="/WEB-INF/Include/Supplier/feedback/detail/feedback_detail.jsp"/>
                        <!-- /.col -->
                    </div>
