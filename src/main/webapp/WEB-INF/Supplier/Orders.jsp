                ...
                <section class="content-header">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                <jsp:include page="/WEB-INF/Include/Supplier/order/box/filter_box.jsp"/>
                            </div>
                            <!-- /.box-body -->
                        </div>
                            ...
                            <div id="order_items" class="box-body">
                                <div class="table-responsive">
                                    <c:if test="${not empty listOrders.content}">
                                        <jsp:include page="/WEB-INF/Include/Supplier/order/order_table/order_table.jsp"></jsp:include>
