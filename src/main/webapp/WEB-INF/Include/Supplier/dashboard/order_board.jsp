    ...
    <div class="col-md-8">
        <div class="box box-info">
                    ...
                    <table class="table no-margin">
                        ...
                        <tbody>
                            <c:forEach var="order" items="${listOrders.content}" varStatus="status">
                                <tr>
                                    <s:url var="orderdetail" value="/Supplier/OrderDetail?id=${order.orderId}"/>
                                    ...
                                    <td>
                                        <fmt:formatDate pattern="dd/MM/yyyy" value="${order.updateDate}"/>
                                    </td>
                                    <td>
                                        $
            ...
            <div class="box-footer clearfix" style="display: block;">
                <s:url value="/Supplier/Orders" var="orders"/>
                <a href="${orders}" class="btn btn-sm btn-default btn-flat pull-right">Xem tất cả đơn hàng</a>
            </div>
            <!-- /.box-footer -->
        </div>
    </div>
