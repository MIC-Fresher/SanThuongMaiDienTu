                    ...
                    <tbody>
                        ...
                        <c:forEach var="order" items="${order.orderdetailList}" varStatus="status">
                            <tr id="${order.orderDetailId}">
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${order.productId.stock == 0}">
                                            hết hàng

                                        </c:when>
                                        <c:otherwise>
                                            <c:set value="${order.productId.stock}" var="numberproduct"/>
                                            <form:select path="orderdetailList[${status.index}].quantity"  class="cart_quantity_input">
                                                <c:forEach begin="1" end="${numberproduct}" var="i">
                                    ...
                                    <form:hidden path="orderdetailList[${status.index}].orderDetailId"/>
                                </td>
