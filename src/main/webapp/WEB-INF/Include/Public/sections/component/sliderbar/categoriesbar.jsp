                ...
                <div class="panel-body">
                    <ul>
                        <c:forEach items="${Groupcategories.categoryList}" var="category"  varStatus="status">
                            ...
                            <s:url value="/Public/searchProducts?categoryname=${category.categoryName}&${parameterUrl.toStringCategory()}" var="searchbycategory"/>
                            <li>
                                <a onclick="" href="${searchbycategory}">${category.categoryName}</a>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
