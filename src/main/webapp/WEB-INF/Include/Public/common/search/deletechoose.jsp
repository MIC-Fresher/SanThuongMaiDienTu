    ...
    <ul class="nav">
        ...
        <li>
            <c:if test="${not empty parameterUrl.categoryname }">
                <s:url value="/Public/searchProducts?${parameterUrl.toStringCategory()}" var="deletecatagory"/>
        ...
        <li>
            <c:if test="${not empty parameterUrl.totalvote}">
                <s:url value="/Public/searchProducts?${parameterUrl.toStringVote()}" var="deletevote"/>
        ...
        <li><c:if test="${not empty parameterUrl.fromprice and not empty parameterUrl.toprice}">
                ...
                <s:url value="/Public/searchProducts?${parameterUrl.toStringPrice()}" var="deleteprice"/>
        ...
        <li>
            <c:if test="${not empty parameterUrl.shopname}">
                ...
                <s:url value="/Public/searchProducts?${parameterUrl.toStringShop()}" var="deleteshopname"/>
        ...
        <li>
            <c:if test="${not empty parameterUrl.searchinput}">
                <s:url value="/Public/searchProducts?${parameterUrl.toStringSearchInput()}" var="deletesearchinput"/>
